...
function this:GetPlaySpeedSetting()
    local slowestPlaySpeed = fight_play_speed_default and fight_play_speed_default * 0.02 or 2;
    local fastestPlaySpeed = fight_play_speed_faster and fight_play_speed_faster * 0.03 or 5;
